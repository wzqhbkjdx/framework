...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * The following field is used as a buffer for internal calculations. Its
     * sole purpose is to avoid allocating new Rect every time we need one.
     */
    ...
    private StickyRecyclerHeadersDecoration(BaseStickyHeaders adapter, OrientationProvider orientationProvider, DimensionCalculator dimensionCalculator) {
    ...
    private StickyRecyclerHeadersDecoration(BaseStickyHeaders adapter, OrientationProvider orientationProvider, DimensionCalculator dimensionCalculator, HeaderRenderer headerRenderer,
    ...
    private StickyRecyclerHeadersDecoration(BaseStickyHeaders adapter, HeaderRenderer headerRenderer, OrientationProvider orientationProvider, DimensionCalculator dimensionCalculator,
                                            HeaderProvider headerProvider, HeaderPositionCalculator headerPositionCalculator) {
        mAdapter = adapter;
    ...
    /**
     * Sets the offsets for the first item in a section to make room for the
     * header view
     *
     * @param itemOffsets
     *            rectangle to define offsets for the item
     * @param header
     *            view used to calculate offset for the item
     * @param orientation
     *            used to calculate offset for the item
     */
    ...
    /**
     * Invalidates cached headers. This does not invalidate the recyclerview,
     * you should do that manually after calling this method.
     */
