...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    protected onTouchVideoListener touchVideoListener;
    protected StaticsCallBack staticsCallBack;

    public interface onTouchVideoListener {
        void onTouch();
    }

    public interface StaticsCallBack {
        void onVideoStart();
        void onVideoAutoComplete();
    }

    public void setOnTouchVideoListener(onTouchVideoListener listener) {
        this.touchVideoListener = listener;
    }

    public void setStaticsCallBack(StaticsCallBack callBack) {
        this.staticsCallBack = callBack;
    }
    ...
    public void onClick(View v) {
        Log.v("video_player_appsflayer", "onclick");

        int i = v.getId();
        if(touchVideoListener != null) {
            touchVideoListener.onTouch();
        }

        if (i == R.id.start) {
            if(staticsCallBack != null) {
                staticsCallBack.onVideoStart();
            }
...
//                        mDownY = y;
    ...
    public void onAutoCompletion() {
        Log.v("video_player_appsflayer", "on auto Completion");
        if(staticsCallBack != null) {
            staticsCallBack.onVideoAutoComplete();
        }
    ...
    public void onCompletion() {
        videoTime.setVisibility(VISIBLE);
        Log.v("video_player_appsflayer", "onCompletion");
