...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void setVideoTime(String videoTime) {
        this.videoTime.setText(videoTime);
    }

    public void hideVideoTime() {
        this.videoTime.setVisibility(GONE);
    }

    public void showVideoTime() {
        this.videoTime.setVisibility(VISIBLE);
    }
    ...
    public void setTitleTextView(float size){
        titleSize = size;
    }
    ...
    public void showWifiDialog() {
        ...
        Log.v("wangzq_video_player", "dialog show ");
...
//        builder.create().show();
    ...
    private static class ConfirmDialogInterface implements CustomVideoDialog.DialogCallback {
        private WeakReference<JCVideoPlayerStandard> jcVideoPlayerStandardWeakReference;

        public ConfirmDialogInterface(JCVideoPlayerStandard jcVideoPlayerStandard) {
            jcVideoPlayerStandardWeakReference = new WeakReference<>(jcVideoPlayerStandard);
        }

        @Override
        public void confirm() {
            if(jcVideoPlayerStandardWeakReference.get() != null) {
                jcVideoPlayerStandardWeakReference.get().startVideo();
                jcVideoPlayerStandardWeakReference.get().WIFI_TIP_DIALOG_SHOWED = true;
            }
        }
        ...
        public void dialogCancel() {
            if(jcVideoPlayerStandardWeakReference.get() != null) {
                if (jcVideoPlayerStandardWeakReference.get().currentScreen == SCREEN_WINDOW_FULLSCREEN) {
                    jcVideoPlayerStandardWeakReference.get().clearFullscreenLayout();
                }
            }
        }
    }
    ...
    private void showNoWifiDialog() {
        ConfirmDialogInterface editDialogInterface = new ConfirmDialogInterface(this);
        final CustomVideoDialog editDialog = new CustomVideoDialog(getContext(), editDialogInterface);
        editDialog.setDialogTitle(getResources().getString(R.string.tips_not_wifi));
        editDialog.setConfirmText(getResources().getString(R.string.tips_not_wifi_confirm));
        editDialog.setCancelText(getResources().getString(R.string.tips_not_wifi_cancel));
    ...
    public void startVideo() {
        Log.v("video_player_appsflayer", "start video");
        prepareMediaPlayer();
