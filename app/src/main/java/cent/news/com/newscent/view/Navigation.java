...
public class Navigation extends FrameLayout {
    ...
    private int										noSelectitem						= -1;

    private int										noSelectitem2						= -1;

    private int										noSelectitem3						= -1;

    // Listener
    private OnTabSelectedListener					tabSelectedListener;

    private OnTabNotSelectedListener				tabNotSelectedListener;
    ...
    private AHBottomNavigationBehavior<Navigation> bottomNavigationBehavior;
    ...
    @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isBehaviorTranslationSet) {
            // The translation behavior has to be set up after the
            // super.onMeasure has been called.
    ...
    private void init(Context context) {
        ...
        bottomNavigationHeight = (int) resources.getDimension(R.dimen.tab_height);

        // Item colors
        itemActiveColor = ContextCompat.getColor(context, com.aurelhubert.ahbottomnavigation.R.color.colorBottomNavigationAccent);
        itemInactiveColor = ContextCompat.getColor(context, com.aurelhubert.ahbottomnavigation.R.color.colorBottomNavigationInactive);
        // Colors for colored bottom navigation
        coloredTitleColorActive = ContextCompat.getColor(context, com.aurelhubert.ahbottomnavigation.R.color.colorBottomNavigationActiveColored);
        coloredTitleColorInactive = ContextCompat.getColor(context, com.aurelhubert.ahbottomnavigation.R.color.colorBottomNavigationInactiveColored);

        // Notifications
        notificationActiveMarginLeft = (int) resources.getDimension(com.aurelhubert.ahbottomnavigation.R.dimen.bottom_navigation_notification_margin_left);
        notificationInactiveMarginLeft = (int) resources.getDimension(R.dimen.default_padding_bottom);

        ViewCompat.setElevation(this, resources.getDimension(R.dimen.tab_height_bottom_padding));
        setClipToPadding(false);

        ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, bottomNavigationHeight);
    ...
    private void createClassicItems(LinearLayout linearLayout) {
        ...
        float minWidth = resources.getDimension(com.aurelhubert.ahbottomnavigation.R.dimen.bottom_navigation_min_width);
        float maxWidth = resources.getDimension(com.aurelhubert.ahbottomnavigation.R.dimen.bottom_navigation_max_width);

        if (forceTitlesDisplay && items.size() > MIN_ITEMS) {
            minWidth = resources.getDimension(R.dimen.tab_height);
            maxWidth = resources.getDimension(com.aurelhubert.ahbottomnavigation.R.dimen.bottom_navigation_small_inactive_max_width);
        }
        ...
        float activeSize = resources.getDimension(com.aurelhubert.ahbottomnavigation.R.dimen.bottom_navigation_text_size_active);
        float inactiveSize = resources.getDimension(com.aurelhubert.ahbottomnavigation.R.dimen.bottom_navigation_text_size_inactive);
        int activePaddingTop = (int) resources.getDimension(R.dimen.tab_height_top_padding);

        int activeMarginTop = (int) resources.getDimension(R.dimen.tab_height_top_padding);
        int inactiveMarginTop = (int) resources.getDimension(R.dimen.tab_height_bottom_padding);
        ...
        if (titleActiveTextSize != 0 && titleInactiveTextSize != 0) {
            ...
            activeSize = resources.getDimension(com.aurelhubert.ahbottomnavigation.R.dimen.bottom_navigation_text_size_forced_active);
            inactiveSize = resources.getDimension(com.aurelhubert.ahbottomnavigation.R.dimen.bottom_navigation_text_size_forced_inactive);
        }
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            View view = inflater.inflate(R.layout.layout_home_item, this, false);
            ...
            // p.setMargins(p.leftMargin, activePaddingTop, p.rightMargin,
            // p.bottomMargin);
            // }
            ...
            if (i == currentItem) {
                ...
                if (view.getLayoutParams() instanceof MarginLayoutParams) {
                    ...
                    MarginLayoutParams paramsNotification = (MarginLayoutParams) notification.getLayoutParams();
                ...
                // AHHelper.updateTopMargin(icon, activeMarginTop,
                // inactiveMarginTop);
    ...
    private void createSmallItems(LinearLayout linearLayout) {
        ...
        float height = resources.getDimension(R.dimen.tab_height);
        float minWidth = resources.getDimension(R.dimen.tab_height);
        ...
        int activeMarginTop = (int) resources.getDimension(R.dimen.tab_height_bottom_padding);
        float difference = resources.getDimension(R.dimen.tab_height_bottom_padding);
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            LayoutParams params = new LayoutParams(i == currentItem ? (int) selectedItemWidth : (int) itemWidth, (int) height);
            linearLayout.addView(view, params);
            views.add(view);
        }
    ...
    public void setNoSelectitem(int position) {
        this.noSelectitem = position;
    }

    public void setNoSelectitem2(int position) {
        this.noSelectitem2 = position;
    }

    public void setNoSelectitem3(int position) {
        this.noSelectitem3 = position;
    }
     ...
     *
     * @param itemIndex
     *            int: Selected item position
     * @param useCallback
     *            boolean: Use or not the callback
     */
    private void updateItems(final int itemIndex, boolean useCallback) {

        if (itemIndex == noSelectitem || itemIndex == noSelectitem2 || itemIndex == noSelectitem3) {
            if (tabNotSelectedListener != null) {
                tabNotSelectedListener.onNotSelected(itemIndex);
            }
            return;
        }
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            if (i == itemIndex) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && colored) {
                    ...
                    AHHelper.updateViewBackgroundColor(this, currentColor, items.get(itemIndex).getColor(context));
                } else {
                    setBackgroundColor(defaultBackgroundColor);
                    backgroundColorView.setBackgroundColor(Color.TRANSPARENT);
                }
    ...
    public void showICon(int position, int res) {
        if (views.size() < 1) {
            return;
        }
        ...
        final TextView title = (TextView) views.get(position).findViewById(R.id.bottom_navigation_item_title);
        final ImageView icon = (ImageView) views.get(position).findViewById(R.id.bottom_navigation_item_icon);
        final TextView notification = (TextView) views.get(position).findViewById(R.id.bottom_navigation_notification);

        AHHelper.updateTopMargin(icon, inactiveMarginTop, activeMarginTop);
        AHHelper.updateLeftMargin(notification, notificationInactiveMarginLeft, notificationActiveMarginLeft);
        AHHelper.updateTextColor(title, itemInactiveColor, itemActiveColor);
        AHHelper.updateTextSize(title, inactiveSize, activeSize);
        items.get(position).setDrawable(res);
        icon.setImageDrawable(items.get(position).getDrawable(context));
    }

    public void hideIcon(int position, int res) {
        if (views.size() < 1) {
            return;
        }
        int activeMarginTop = (int) resources.getDimension(R.dimen.tab_height_top_padding);
        ...
        MarginLayoutParams p = (MarginLayoutParams) icon.getLayoutParams();
        p.setMargins(p.leftMargin, (int) inactiveMarginTop, p.rightMargin, p.bottomMargin);
    ...
    private void updateSmallItems(final int itemIndex, boolean useCallback) {
        ...
        int activeMarginTop = (int) resources.getDimension(R.dimen.tab_height_top_padding);
        int inactiveMargin = (int) resources.getDimension(R.dimen.tab_height_padding);
...
//				AHHelper.updateAlpha(title, 1, 0);
    ...
    private void updateNotifications(boolean updateStyle, int itemPosition) {
        ...
        for (int i = 0; i < views.size(); i++) {
            ...
            ImageView image = (ImageView) views.get(i).findViewById(R.id.iv_new);
            ...
            if (updateStyle) {
                ...
                if (notificationBackgroundDrawable != null) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        notification.setBackground(AHHelper.getTintDrawable(defautlDrawable, notificationBackgroundColor, forceTint));
                    } else {
                        notification.setBackgroundDrawable(AHHelper.getTintDrawable(defautlDrawable, notificationBackgroundColor, forceTint));
                    }
                }
            }
            ...
            if (notifications[i].length() == 0 && notification.getText().length() > 0) {
                ...
                if (notifications[i].equals(MainActivity.NEW)) {
     ...
     *
     * @return 返回值 The bottom navigation background color
     */
     ...
     *            The bottom navigation background color
     */
     ...
     *
     * @return 返回值 The default accent color
     */
     ...
     * @param position
     *            int: item position
     * @return 返回值 The item at the given position
     */
     ...
     *
     * @return 返回值 The current item position
     */
    ...
    public void hideBottomNavigation(boolean withAnimation) {
        if (bottomNavigationBehavior != null) {
            ...
            ViewCompat.animate(this).translationY(bottomNavigationHeight).setInterpolator(new LinearOutSlowInInterpolator()).setDuration(withAnimation ? 300 : 0).start();
        }
    }
    ...
    public void restoreBottomNavigation(boolean withAnimation) {
        if (bottomNavigationBehavior != null) {
            ...
            ViewCompat.animate(this).translationY(0).setInterpolator(new LinearOutSlowInInterpolator()).setDuration(withAnimation ? 300 : 0).start();
        }
    }
    ...
    /**
     * Set the force tint value If forceTint = true, the tint is made with
    ...
    /**
     * Force the titles to be displayed (or used the classic behavior) Note:
     * Against Material Design guidelines
     *
     * @param forceTitlesDisplay
     *            Boolean
     */
    ...
    public void setOnTabNotSelectedListener(OnTabNotSelectedListener tabNotSelectedListener) {
        this.tabNotSelectedListener = tabNotSelectedListener;
    }
     ...
     *            int
     */
    @Deprecated public void setNotification(int nbNotification, int itemPosition) {
     ...
     * 未选中
     */
    public interface OnTabNotSelectedListener {

        void onNotSelected(int position);
    }
