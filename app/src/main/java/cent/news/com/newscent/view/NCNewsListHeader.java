...
public class NCNewsListHeader extends FrameLayout implements PtrUIHandler {
    ...
    @Override public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.pull));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.pull));
        }
    }
    ...
    @SuppressLint("CommitPrefEdits") @Override public void onUIRefreshComplete(PtrFrameLayout frame) {
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(R.string.pull_update);
        }
    }
